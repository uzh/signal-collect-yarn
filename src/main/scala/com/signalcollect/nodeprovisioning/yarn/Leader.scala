...
class Leader(nodes: List[ContainerInfo], akkaPort: Int, kryoRegistrations: List[String], kryoInitializer: String = "com.signalcollect.configuration.KryoInit") extends LogHelper {
