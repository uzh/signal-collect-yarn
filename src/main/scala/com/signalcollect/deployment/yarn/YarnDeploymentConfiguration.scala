...
case class YarnDeploymentConfiguration(
  ...
  containerClass: String = "com.signalcollect.deployment.NodeContainerApp",
...
object YarnDeploymentConfigurationCreator {
  ...
  def getYarnDeploymentConfiguration(config: Config, basicConfig: DeploymentConfiguration): YarnDeploymentConfiguration = {
    ...
    new YarnDeploymentConfiguration(
      ...
      containerClass = get[String]("deployment.container-class").getOrElse("com.signalcollect.deployment.NodeContainerApp"),
      ...
      killOtherNodes = get[Boolean]("deployment.kill-nodes").getOrElse(false),
