...
package com.signalcollect.yarn.utility;
...
/**
 * Finds the Jar for a class. If the class is in a directory in the classpath,
 * it creates a Jar on the fly with the contents of the directory and returns
 * the path to that Jar. If a Jar is created, it is created in the system
 * temporary directory.
 */
