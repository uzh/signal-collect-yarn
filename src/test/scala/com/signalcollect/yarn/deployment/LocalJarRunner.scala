...
object LocalJarRunner {
  ...
  def run(classpath: String, mainClass: String, arguments: String = "") {
    val completeClasspath = classpath +  ":/home/tobi/Dropbox/uni/Bachelorarbeit/workspace/signal-collect-yarn-dependencies/target/scala-2.10/signal-collect-yarn-assembly-1.0-SNAPSHOT.jar"
